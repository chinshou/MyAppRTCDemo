...
public class CallActivity extends Activity
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    //signalingParameters.iceServers.add(new PeerConnection.IceServer("https://api.diveinedu.com/apprtc/iceconfig.php?key=AIzaSyAJdh2HkajseEIltlZ3SIXO02Tze9sO3NY","1466157196:diveinedu","NTdhMmMxMTQ4OTk4MzFhY2Y3MzBmODZhYWVhZDk5ODBkMWQ2ODhlOA=="));
    //signalingParameters.iceServers.add(new PeerConnection.IceServer("stun:61.152.239.60","",""));
